...
class LicenseKeyView  
    extends LicenseKey {
        ...
        // this method renders users license keys in table
        ...
        // this method renders users active license keys in table
        ...
        // this method renders users inactive license keys in table
        public function showAllUserLicenseKeysDeactivate($user_id) {
            ...
            if (is_countable($license_keys) && count($license_keys) > 0) {
                ...
                echo '<p>You have no inactive license keys</p>';
            }
